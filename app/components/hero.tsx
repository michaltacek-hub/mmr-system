...
<div className="absolute top-4 left-4 md:-top-16 md:left-16 z-20">
  <Image
    src="/navbar2.png"
    alt="Masáže Michelle"
    width={360}
  ...
  />
      ...
      {/* Content */}
     <div className="relative z-10 flex h-full w-full max-w-4xl flex-col items-center justify-center -translate-y-10 translate-x-5 md:translate-x-0 md:translate-y-0">
       <h1
 className="text-white text-5xl md:text-8xl font-semibold leading-tight mb-8"
